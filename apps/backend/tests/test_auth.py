...
class TestAuthenticateUser:
    ...
    def test_authenticate_user_success(self, db_session: Session):
        ...
        # Test authentication
        authenticated_user = authenticate_user(db_session, "test@example.com", "testpassword")
    ...
    def test_authenticate_user_wrong_password(self, db_session: Session):
        ...
        # Test authentication with wrong password
        authenticated_user = authenticate_user(db_session, "test@example.com", "wrongpassword")
        
        assert authenticated_user is None
    
    def test_authenticate_user_nonexistent(self, db_session: Session):
        """Test authentication with nonexistent user."""
        authenticated_user = authenticate_user(db_session, "nonexistent@example.com", "testpassword")
...
class TestGetCurrentUser:
    ...
    @patch('auth.jwt.decode')
    def test_get_current_user_nonexistent_user(self, mock_jwt_decode, db_session: Session):
